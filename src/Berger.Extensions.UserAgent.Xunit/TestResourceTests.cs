...
namespace Berger.Extensions.UserAgent.Tests
{
    public class TestResourceTests
    {
        ...
        {
            RunTests("Berger.Extensions.UserAgent.Tests.TestResources.test_device.yaml", DeviceYamlTestCase.ReadFromMap);
        }

        [Fact]
        public void can_run_additional_os_tests()
        {
            RunTests("Berger.Extensions.UserAgent.Tests.TestResources.additional_os_tests.yaml", OSYamlTestCase.ReadFromMap);
        }

        [Fact]
        public void can_run_firefox_user_agent_string_tests()
        {
            RunTests("Berger.Extensions.UserAgent.Tests.TestResources.firefox_user_agent_strings.yaml", UserAgentYamlTestCase.ReadFromMap);
        }

        [Fact]
        public void can_run_pgts_browser_list_tests()
        {
            RunTests("Berger.Extensions.UserAgent.Tests.TestResources.pgts_browser_list.yaml", UserAgentYamlTestCase.ReadFromMap);
        }

        [Fact]
        public void can_run_user_agent_parser_tests()
        {
            RunTests("Berger.Extensions.UserAgent.Tests.TestResources.test_ua.yaml", UserAgentYamlTestCase.ReadFromMap);
        }

        [Fact]
        public void can_run_user_agent_parser_os_tests()
        {
            RunTests("Berger.Extensions.UserAgent.Tests.TestResources.test_os.yaml", OSYamlTestCase.ReadFromMap);
        }
